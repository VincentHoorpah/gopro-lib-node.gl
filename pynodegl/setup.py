...
''' % class_data
            ...
            # Buffer*(_Buffer), AnimatedBuffer*(_AnimatedBuffer) This case is
            # for nodes such as Buffer* or AnimatedBuffer* that share a common
            # set of parameters. These class will inherit all the parameters
            # and their initializers from their parent class but still need to
            # identify individually by instantiating a specific C node (with
            # ngl_node_create()).
